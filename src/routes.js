...
const routes = [
  ...
  { path: '/enrollment', name: 'enrollment', title__main: '상품',title__sub: '상품 자세히 보기',component: Breadcrumbs,etc: Typography, layout: Sub },
  { path: '/arrival', name: 'arrival', title__main: '출고시작',title__sub: '입고서', component: Typography, etc: Colors, layout: Sub },
